...
Microsoft.WebPortal.Services.HeaderBar.prototype.addBreadcrumb = function (active, navigation, text) {
    /// <summary>
    /// Adds a breadcrumb to the header bar. This is used for navigation purposes.
    /// </summary>
    this.webPortal.Helpers.throwIfNotSet(text, "text", "Microsoft.WebPortal.Services.HeaderBar.addBreadcrumb");

    this.breadcrumbs.push({ 'active': active, 'navigation': navigation, 'text': text });
}
...
Microsoft.WebPortal.Services.HeaderBar.prototype.resetBreadcrumbs = function () {
    /// <summary>
    /// Removes all breadcrumbs from the header bar. 
    /// </summary>
