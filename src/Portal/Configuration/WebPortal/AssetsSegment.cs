...
namespace Microsoft.Hex.Migration.Toolkit.Portal.Configuration.WebPortal
{
    ...
    public class AssetsSegment : ICloneable
    {
        ...
        public object Clone()
        {
            return new AssetsSegment() { Name = Name, DefaultAssetVersion = DefaultAssetVersion, Assets = Assets.Clone() };
        }
    }
}