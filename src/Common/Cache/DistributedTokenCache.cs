...
namespace Microsoft.Hex.Migration.Toolkit.Common.Cache
{
    ...
    public class DistributedTokenCache : TokenCache
    {
        ...
        /// </summary>
        private string Key => string.IsNullOrEmpty(keyValue) ? $"Resource::{resource}::Identifier::{ClaimsPrincipal.Current.Identities.First().FindFirst(ObjectIdClaimType).Value}" : this.keyValue;
